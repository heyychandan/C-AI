...
const BACKEND = "https://c-ai-reer.onrender.com";
...
function App() {
  ...
  const sendMessage = async (text) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post(BACKEND + "/chat", { session_id: SESSION_ID, message: msg, mode });
  ...
  const handlePdfUpload = async (e) => {
    ...
    try {
      const res = await axios.post(BACKEND + "/upload-pdf", formData);
  ...
  const clearChat = async () => {
    await axios.post(BACKEND + "/clear", { session_id: SESSION_ID });
